...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["new_password"]))){
        $new_password_err = "Sh&euml;noni fjal&euml;kalimin e ri.";     
    } elseif(strlen(trim($_POST["new_password"])) < 6){
        $new_password_err = "Fjal&euml;kalimi duhet t&euml; k&euml;t&euml; min. 6 karaktere.";
    } else{
    ...
    if(empty(trim($_POST["confirm_password"]))){
        $confirm_password_err = "Ju lutemi konfirmoni fjal&euml;kalimin.";
    } else{
    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        ...
        $sql = "UPDATE administratori SET password = ? WHERE id = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "Dicka shkoi keq. Ju lutem provoni p&euml;rs&euml;ri me von&euml;.";
            }
        }

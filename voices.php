    ...
    <body>
        ...
        <div id="bg-nav" style="height:478px;">
            <header class="header-section">
                                    ...
                                    <div class="main-menu">
                                        <nav>
                                            <ul>
                                                ...
                                                <li><a class="active" href="../2020/voices.php"><i class="fas fa-male"></i> Speakers</a></li>
                ...
                <h3 class="weektext">Speakers - 2020</h3>        
            ...
            <div class="container">
                <div>
                    ...
                    <div class="row">      
                        ...
                        $sql = "SELECT `id`, `Emri`, `Mbiemri`, `Foto` ,`Vendi`,`Profesioni`,`Biografia` FROM `folesit`";
